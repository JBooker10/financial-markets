...
export default {
    extends: Line,
    props: { symbol: String, actualEPS: Array, consensusEPS: Array, fiscalPeriod: Array},
    data() {
        return {
    ...
    watch: {
        consensusEPS: function () {
          return this.renderEarnings(this.fiscalPeriod, this.actualEPS, this.gradient, this.consensusEPS, this.symbol)
       }
    },
    mounted () {
         ...
         this.gradient = this.$refs.canvas
          ...
          this.renderEarnings(this.fiscalPeriod, this.actualEPS, this.gradient, this.consensusEPS, this.symbol)
    }
}
</script>
