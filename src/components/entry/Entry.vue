...
export default {
    ...
    data() {
        return {
            symbols: ['MSFT', 'AAPL', 'SNAP', 'FB', 'NFLX', 'JPM', 'IBM', 
            'GOOGL', 'INTC', 'AMZN', 'XOM', 'WFC', 'V', 'BAC', 'WMT', 'JNJ', 'PG', 'CVX', 'BUD'],
            iterator: 0,
            timer: null
        }
    },
